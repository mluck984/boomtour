 ...
 */
 ...
 jQuery(document).ready(function(){
	...
	jQuery('#gdl_background_style').change(function(){
		if(jQuery(this).val() == 'Predefined Image'){
			jQuery(this).parents('.panel-body').siblings('.body-gdl_predefined_image').slideDown();
			jQuery(this).parents('.panel-body').siblings('.body-gdl_background_custom').slideUp();
		}else if(jQuery(this).val() == 'Custom Image'){
			jQuery(this).parents('.panel-body').siblings('.body-gdl_predefined_image').slideUp();
	...
	jQuery('#gdl_background_style').each(function(){
		if(jQuery(this).val() == 'Predefined Image'){
			jQuery(this).parents('.panel-body').siblings('.body-gdl_predefined_image').css('display','block');
			jQuery(this).parents('.panel-body').siblings('.body-gdl_background_custom').css('display','none');
		}else if(jQuery(this).val() == 'Custom Image'){
			jQuery(this).parents('.panel-body').siblings('.body-gdl_predefined_image').css('display','none');
