...
jQuery(document).ready(function(){ 
	...
	jQuery("#page_template").change(function(){
		if(jQuery(this).val() == 'page.php' || jQuery(this).val() == 'default' ){
			jQuery("#gdl-default-template-wrapper").slideDown();
			jQuery("#portfolio-board-wrapper").slideUp();
			jQuery("#blog-board-wrapper").slideUp();
		}else if(jQuery(this).val() == 'page-blog-board.php'){
			jQuery("#gdl-default-template-wrapper").slideUp();
			jQuery("#portfolio-board-wrapper").slideUp();
			jQuery("#blog-board-wrapper").slideDown();
		}else{
			jQuery("#gdl-default-template-wrapper").slideUp();
			jQuery("#portfolio-board-wrapper").slideDown();
			jQuery("#blog-board-wrapper").slideUp();		
		}
	});
	jQuery('#page_template').each(function(){
		if(jQuery(this).val() == 'page.php' || jQuery(this).val() == 'default' ){
			jQuery("#gdl-default-template-wrapper").css('display', 'block');
			jQuery("#portfolio-board-wrapper").css('display', 'none');
			jQuery("#blog-board-wrapper").css('display', 'none');
		}else if(jQuery(this).val() == 'page-blog-board.php'){
			jQuery("#gdl-default-template-wrapper").css('display', 'none');
			jQuery("#portfolio-board-wrapper").css('display', 'none');
			jQuery("#blog-board-wrapper").css('display', 'block');
		}else{
			jQuery("#gdl-default-template-wrapper").css('display', 'none');
			jQuery("#portfolio-board-wrapper").css('display', 'block');
			jQuery("#blog-board-wrapper").css('display', 'none');		
		}
	});	
