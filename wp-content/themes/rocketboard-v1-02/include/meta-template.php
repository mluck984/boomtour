	...
	*/
	...
	function print_meta($meta_box){
		...
		switch($meta_box['type']){
			...
			case "colorpicker": print_color_picker($meta_box); break;
		}
	...
	// color_picker => name, title, value, default
	function print_color_picker($args){
		extract($args);
			...
			<div class="meta-body <?php echo $meta_body; ?>">
				...
				<div class="meta-input">
					...
					<div class="color-transparent-wrapper">
						...
						?>/> <span class="color-transparent"><label for="<?php echo $name; ?>"> default color </label></span>
					</div>				
				</div>
