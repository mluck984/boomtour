<?php 
	...
	*/
	...
	$page_meta_boxes = array(
		"Default Template Open" => array( 'type'=>'open', 'id'=>'gdl-default-template-wrapper'),
				...
				'Blog'=>array(
					...
					'item-size'=>array(
						...
						'options'=>array('0'=>'1/4 Blog Widget', '2'=>'1/3 Blog Widget', 
							'3'=>'1/2 Blog Widget', '4'=>'1/1 Blog Widget', '5'=>'1/1 Full Thumbnail'),
						'type'=>'combobox',
		...
		"Page Title" => array(
			...
			'description' => 'Show Page title at the top of the page( below the main navigation menu ).'
		),	
		...
		"Default Template Close" => array( 'type'=>'close' ),
		
		"Portfolio Board Open" => array( 'type'=>'open', 'id'=>'portfolio-board-wrapper'),

		"Portfolio Board Title" => array(
			'title'=> __('PAGE TITLE', 'gdl_back_office'),
			'name'=>'page-option-portfolio-board-title',
			'type'=>'inputtext',
		),	
		
		"Portfolio Board Caption" => array(
			'title'=> __('PORTFOLIO CAPTION', 'gdl_back_office'),
			'name'=>'page-option-portfolio-board-caption',
			'type'=>'textarea',
		),		
		
		"Portfolio Board Category" => array(
			'title'=> __('PORTFOLIO CATEGORY', 'gdl_back_office'),
			'name'=>'page-option-portfolio-board-category',
			'options'=>array(),
			'type'=>'combobox',
		),
		
		"Portfolio Board Num Fetch" => array(
			'title'=> __('PORTFOLIO NUM FETCH', 'gdl_back_office'),
			'name'=>'page-option-portfolio-board-num-fetch',
			'type'=>'inputtext',
			'default'=>'15',
		),		

		"Portfolio Board Filter" => array(
			'title'=> __('PORTFOLIO BOARD FILTER', 'gdl_back_office'),
			'name'=>'page-option-portfolio-board-filter',
			'type'=>'combobox',
			'options'=> array('Yes', 'No')
		),		
		
		"Portfolio Board Pagination" => array(
			'title'=> __('PORTFOLIO BOARD PAGINATION', 'gdl_back_office'),
			'name'=>'page-option-portfolio-board-pagination',
			'type'=>'combobox',
			'options'=> array('No', 'Yes'),
			'hr'=>'none'
		),			
		
		"Portfolio Board Close" => array( 'type'=>'close' ),
		
		"Blog Board Open" => array( 'type'=>'open', 'id'=>'blog-board-wrapper'),

		"Blog Board Title" => array(
			'title'=> __('PAGE TITLE', 'gdl_back_office'),
			'name'=>'page-option-blog-board-title',
			'type'=>'inputtext',
		),	
		
		"Blog Board Caption" => array(
			'title'=> __('BLOG CAPTION', 'gdl_back_office'),
			'name'=>'page-option-blog-board-caption',
			'type'=>'textarea',
		),		
		
		"Blog Board Category" => array(
			'title'=> __('BLOG CATEGORY', 'gdl_back_office'),
			'name'=>'page-option-blog-board-category',
			'options'=>array(),
			'type'=>'combobox',
		),
		
		"Blog Board Num Fetch" => array(
			'title'=> __('BLOG NUM FETCH', 'gdl_back_office'),
			'name'=>'page-option-blog-board-num-fetch',
			'type'=>'inputtext',
			'default'=>'15',
		),		
		
		"Blog Board Filter" => array(
			'title'=> __('BLOG BOARD FILTER', 'gdl_back_office'),
			'name'=>'page-option-blog-board-filter',
			'type'=>'combobox',
			'options'=> array('Yes', 'No')
		),			
		
		"Blog Board Pagination" => array(
			'title'=> __('BLOG BOARD PAGINATION', 'gdl_back_office'),
			'name'=>'page-option-blog-board-pagination',
			'type'=>'combobox',
			'options'=> array('No', 'Yes'),
			'hr'=>'none'
		),			
		
		"Blog Board Close" => array( 'type'=>'close' ),		
	);
	...
	function add_page_option_element(){
		...
		$page_meta_boxes['Blog Board Category']['options'] = get_category_list( 'category' );
		$page_meta_boxes['Portfolio Board Category']['options'] = get_category_list( 'portfolio-category' );
