<?php
	...
	*/
	...
	$portfolio_meta_boxes = array(	
		...
		// board thumbnail size
		"Board Thumbnail Size" => array(
			'title'=> __('BOARD THUMBNAIL SIZE', 'gdl_back_office'),
			'name'=>'post-option-board-thumbnail-size',
			'options'=>array(
				'0'=>'1x1', '1'=>'1x2', '2'=>'2x1', '3'=>'2x2'),
			'type'=>'combobox',
			'hr'=>'none'),
			
		"Board Thumbnail Type" => array(
			'title'=> __('BOARD THUMBNAIL TYPE', 'gdl_back_office'),
			'name'=>'post-option-board-thumbnail-type',
			'options'=>array(
				'0'=>'Feature Image', '1'=>'Color Board'),
			'type'=>'combobox',
			'default'=> get_option(THEME_SHORT_NAME.'_board_thumbnail_type','Feature Image'),
			'hr'=>'none'),			
			
		// Board Image thumbnail
		"Open Board Image" => array('type'=>'open','id'=>'board-feature-image'),
		"Board Image" => array(
			'title'=> __('USE FEATURE IMAGE AS BOARD THUMBNAIL IMAGE', 'gdl_back_office'),
			'name'=>'post-option-board-featured-image',
			'type'=>'text',
			'hr'=>'none'),
		"Close Board Image" => array('type'=>'close'),			
		
		// Board Plain Color
		"Open Board Color" => array('type'=>'open','id'=>'board-color'),
		"Board Info" => array(
			'title'=> __('THUMBNAIL INFO', 'gdl_back_office'),
			'name'=>'post-option-color-board-info',
			'options'=>array('None', 'Date', 'Tag', 'Icon'),
			'type'=>'combobox',
			'hr'=>'none'),	
		
			// Board thumbnail Icon
			"Open Board Thumbnail Icon" => array('type'=>'open','id'=>'board-thumbnail-icon'),			
			"Board Thumbnail Icon" => array(
				'title'=> __('BOARD ICON', 'gdl_back_office'),
				'name'=>'post-option-color-board-icon',
				'type'=>'upload',
				'hr'=>'none'),				
			"Board Icon Link " => array(
				'title'=> __('BOARD ICON LINK', 'gdl_back_office'),
				'name'=>'post-option-color-board-icon-link',
				'type'=>'inputtext',
				'hr'=>'none'),						
			"Close Board Thumbnail Icon" => array('type'=>'close'),	

		"Board Color" => array(
			'title'=> __('COLOR', 'gdl_back_office'),
			'name'=>'post-option-color-board-background',
			'default'=>'transparent',
			'type'=>'colorpicker',
			'description'=>'** PLEASE UNCHECK THE DEFAULT COLOR OFF TO SELECT ANOTHER COLOR FOR BOARD ITEM **',
			'hr'=>'none'),				
		"Close Board Color" => array('type'=>'close'),	

		// image thumbnail
		"Open Board Image Link" => array('type'=>'open','id'=>'board-image-link'),
		
		"board image link type" => array(
			'title'=> __('LINK FEATURE IMAGE TO', 'gdl_back_office'),
			'name'=>'post-option-board-image-link-type',
			'hr'=>'none',
			'options'=>array(
				'0'=>'Link to Current Post', 
				'1'=>'Link to URL',
		...
		"board image URL" => array(
			'title'=> __('IMAGE URL', 'gdl_back_office'),
			'name'=>'post-option-board-image-url',
			'type'=>'inputtext',
			),		
				
		"Close Board Image Link" => array('type'=>'close'),
