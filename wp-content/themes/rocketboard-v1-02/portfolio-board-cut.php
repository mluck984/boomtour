	<div class="page-wrapper portfolio-board-page <?php echo $sidebar_array['sidebar_class']; ?>">
		...
		<?php
			...
			$page_title = get_post_meta($post->ID, 'page-option-portfolio-board-title', true);	

			$page_caption = get_post_meta($post->ID, 'page-option-portfolio-board-caption', true);			
			...
			$port_cat = get_post_meta($post->ID, 'page-option-portfolio-board-category', true);	

			$port_cat = ( $port_cat == 'All' )? '': $port_cat;

			$port_num_fetch = get_post_meta($post->ID, 'page-option-portfolio-board-num-fetch', true);				

			$enable_pagination = get_post_meta($post->ID, 'page-option-portfolio-board-pagination', true);				

			$enable_filter = get_post_meta($post->ID, 'page-option-portfolio-board-filter', true);				
			...
			if( $enable_filter == 'Yes' ){
				...
				$category_lists = get_category_list('portfolio-category', $port_cat);
				...
				if( empty($port_cat) ){ 
					...
					$first_category = get_term_by('slug', $port_cat, 'portfolio-category');
